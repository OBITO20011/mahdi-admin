...
المصدر الوحيد للمخطط هو migrations في `supabase/migrations` من `001` حتى `082`. لا تطبق SQL يدويًا من وثيقة قديمة، ولا تستخدم `supabase db reset` على قاعدة الإنتاج. قبل أي تغيير:
