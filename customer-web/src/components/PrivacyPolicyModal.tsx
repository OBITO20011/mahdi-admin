...
const sections = [
  {
    ...
    body: 'عند إرسال طلب نجمع الاسم ورقم الهاتف وعنوان التوصيل والأصناف وطريقة الدفع. موقع الخريطة والملاحظات الإضافية اختيارية عندما تظهر كذلك في النموذج. لا يجمع المتجر بيانات بطاقات دفع.',
  },
  {
  ...
  },
  {
    ...
    body: 'السلة والمفضلة تحفظ محليًا لتسهيل التسوق. عند إرسال طلب، قد تُحفظ نسخة محلية مؤقتة من محاولة الطلب وبياناتها الضرورية حتى نتأكد من نجاحها أو رفضها، وذلك لمنع تكرار الطلب عند انقطاع الاتصال. لا نحفظ رمز التحقق الأمني. خيار «حفظ بياناتي» اختياري ويحفظ بيانات التواصل والعنوان على هذا الجهاز لمدة 30 يومًا، ويمكنك مسحها من Checkout في أي وقت. لا تستخدمه على جهاز مشترك.',
  },
  {
