            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-5 sm:p-7">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2 rounded-3xl border border-emerald-200 bg-emerald-50 p-4">
                  <label className="flex cursor-pointer items-start gap-3"><input type="checkbox" checked={saveCustomerDetails} onChange={(event) => setSaveCustomerDetails(event.target.checked)} className="mt-1 h-4 w-4 accent-emerald-600" /><span><span className="flex items-center gap-1.5 text-xs font-black text-emerald-950"><Save className="h-4 w-4" />حفظ بياناتي على هذا الجهاز</span><span className="mt-1 block text-[10px] font-bold leading-5 text-emerald-800/80">اختياري لتعبئة الاسم والهاتف والعنوان تلقائيًا في الطلب القادم.</span></span></label>
