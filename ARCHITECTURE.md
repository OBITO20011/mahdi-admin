...
- حد قراءة كتالوج المتجر الحالي هو 200 صنف؛ العدد الحي المؤكد أقل من ذلك بكثير. قبل اقتراب الكتالوج من هذه العتبة يجب تنفيذ بحث وpagination خادميين معًا، لا رفع الحد أو تحميل جميع الأصناف في المتصفح.
...
- مصدر المخطط هو `supabase/migrations/001...073`، ويجب مقارنة المجلد مع قاعدة البيانات الحية عبر `npx supabase migration list` قبل أي تغيير.
