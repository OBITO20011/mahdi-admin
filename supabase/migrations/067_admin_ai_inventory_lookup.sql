-- =========================================================================
-- Nawasrah ERP - Admin AI inventory lookup
-- The assistant may read only anonymous product availability, never cost,
-- supplier, customer, order, or warehouse-location data.
-- =========================================================================
...
BEGIN
  PERFORM public.assert_erp_role(
    ...
    'قراءة مخزون مساعد الإدارة الذكي'
  );
