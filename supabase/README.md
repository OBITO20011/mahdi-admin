...
هذا المجلد ليس مرحلة أولية أو مخططًا غير مطبق. يحتوي على migrations المتسلسلة من `001` إلى `094` والمطبقة تباعًا على مشروع Supabase الحي المرتبط بـ `acjtabdqqnpwhdvbvnyw`.
