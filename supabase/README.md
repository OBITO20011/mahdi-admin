...
هذا المجلد ليس مرحلة أولية أو مخططًا غير مطبق. يحتوي على migrations المتسلسلة من `001` إلى `064` والمطبقة على مشروع Supabase الحي المرتبط بـ `acjtabdqqnpwhdvbvnyw`.
